...
PACKS = [
    ...
    },
    {
        ...
        "queries": [
            ...
            ("Spring Landscape MET ap17.66.jpg", "Spring Landscape (Doughty)", "Doughty"),
            ("Alte Nationalgalerie-Daubigny-Spring Landscape DSC8098.jpg", "Spring Landscape (Daubigny)", "Daubigny"),
            ("Munch VARLANDSKAP SPRING LANDSCAPE circa 1923 24 Lot 136", "Spring Landscape (Munch)", "Munch"),
            ("Thorma Spring Landscape 1932", "Spring Landscape (Thorma)", "Thorma"),
        ],
    },
    {
        "id": "new_years",
        ...
        "queries": [
            ...
            ("Party For New Year's Day In New Amsterdam 1636 by George Henry Boughton.jpg", "New Year's Day (Boughton)", "Boughton"),
            ("Frederic Remington - A New Year on the Cimarron - Google Art Project.jpg", "A New Year on the Cimarron", "Remington"),
            ("『春雨集』 摺物帖柳々居辰斎画 若松-Spring Rain Collection (Harusame shū), vol. 2- Pine Shoots and Accoutrements for New Year’s Celebrations MET DP138359.jpg", "New Year Celebrations (Shinsai)", "Shinsai"),
            ("January Celebrating the New Year Yoshitoshi LACMA", "Celebrating the New Year (Yoshitoshi)", "Yoshitoshi"),
            ("Wishing You a Happy New Year Wall print", "Wishing You a Happy New Year (Wall)", "Wall"),
        ],
    },
    {
        "id": "valentines_day",
